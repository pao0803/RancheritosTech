...
export function SponsoredBy() {
  ...
  return (
    <section className="py-8 px-8 lg:py-20">
      ...
      <Typography variant="h1" color="orange" className="mb-6 font-semibold text-3xl" children={undefined} placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
  NUESTROS CLIENTES
</Typography>
